...
<div class="container-fluid login-page" id="admin-login">
    <div class="login-container">
        <div class="form-name"><h2 style="color: #ffffff;"><strong>User Login</strong></h2></div>
        ...
        <form class="form">
            ...
            <div class="row col-sm-offset-4 col-sm-4">
                ...
                <div class="well well-sm center"><a style="text-decoration:none;" href="admin-login.php">Administration Login</a></div>
            </div>
        </form>
    </div>
</div>
